...
--GRANT SELECT,INSERT,UPDATE ON TABLE public.criteria TO remote_user;


--
-- Name: SEQUENCE code_seq; Type: ACL; Schema: public; Owner: postgres
--

--GRANT ALL ON SEQUENCE public.code_seq TO remote_user;


--
-- Name: TABLE criteria_allowed_values; Type: ACL; Schema: public; Owner: postgres
--

--GRANT SELECT,INSERT,UPDATE ON TABLE public.criteria_allowed_values TO remote_user;


--
-- Name: TABLE criteria_types; Type: ACL; Schema: public; Owner: postgres
--

--GRANT SELECT,INSERT,UPDATE ON TABLE public.criteria_types TO remote_user;


--
-- Name: TABLE criteria_values; Type: ACL; Schema: public; Owner: postgres
--

--GRANT SELECT,INSERT,UPDATE ON TABLE public.criteria_values TO remote_user;
...
--GRANT SELECT,INSERT,UPDATE ON TABLE public.data_types TO remote_user;


--
-- Name: TABLE dbms; Type: ACL; Schema: public; Owner: postgres
--

--GRANT SELECT,INSERT,UPDATE ON TABLE public.dbms TO remote_user;


--
-- Name: TABLE dbms_versions; Type: ACL; Schema: public; Owner: postgres
--

--GRANT SELECT,INSERT,UPDATE ON TABLE public.dbms_versions TO remote_user;


--
-- Name: TABLE multiple_choice; Type: ACL; Schema: public; Owner: postgres
--

--GRANT SELECT,INSERT,UPDATE ON TABLE public.multiple_choice TO remote_user;
...
--GRANT SELECT,INSERT,UPDATE ON TABLE public.results TO remote_user;


--
-- Name: SEQUENCE results_seq; Type: ACL; Schema: public; Owner: postgres
--

--GRANT ALL ON SEQUENCE public.results_seq TO remote_user;


--
-- Name: TABLE task_info; Type: ACL; Schema: public; Owner: postgres
--

--GRANT SELECT,INSERT,UPDATE ON TABLE public.task_info TO remote_user;


--
-- Name: SEQUENCE task_info_seq; Type: ACL; Schema: public; Owner: postgres
--

--GRANT ALL ON SEQUENCE public.task_info_seq TO remote_user;
...
--GRANT SELECT,INSERT,UPDATE ON TABLE public.tasks TO remote_user;


--
-- Name: SEQUENCE tasks_seq; Type: ACL; Schema: public; Owner: postgres
--

--GRANT ALL ON SEQUENCE public.tasks_seq TO remote_user;
...
--ALTER DEFAULT PRIVILEGES FOR ROLE postgres IN SCHEMA public GRANT ALL ON SEQUENCES  TO remote_user;
...
--ALTER DEFAULT PRIVILEGES FOR ROLE postgres IN SCHEMA public GRANT SELECT,INSERT,UPDATE ON TABLES  TO remote_user;
